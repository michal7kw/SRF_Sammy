...
# Directory setup
FASTQ_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_Sammy/DATA/Sammy_Seq2_fastq/fastq2"
OUTPUT_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/SRF_Sammy/results2"
...
FASTQ=$(sed -n "${SLURM_ARRAY_TASK_ID}p" sample_list2.txt)
