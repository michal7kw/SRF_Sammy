...
# Directory setup
FASTQ_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/Sammy/DATA/Sammy_Seq2_fastq/fastq2"
OUTPUT_DIR="/beegfs/scratch/ric.broccoli/kubacki.michal/Sammy/results2"
