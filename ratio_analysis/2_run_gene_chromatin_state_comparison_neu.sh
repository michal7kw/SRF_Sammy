...
# # Set variables
# GENE_LIST="${base_dir}/gene_lists/neu_enriched_gene_list_exo_vs_endo.txt"
# RESULTS_DIR="${base_dir}/ratio_analysis/results"
# OUTPUT_DIR="${base_dir}/ratio_analysis/results/neu_enriched_comparison"
...
# Set variables
GENE_LIST="${base_dir}/figures/genelists/NEU_exo.txt"
RESULTS_DIR="${base_dir}/ratio_analysis/results"
OUTPUT_DIR="${base_dir}/ratio_analysis/results/neu_enriched_comparison_mirko_gene_lists"
GENOME_GTF="${base_dir}/DATA/gencode.vM25.basic.annotation.gtf"
PROMOTER_SIZE=2000
