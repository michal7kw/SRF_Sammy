#!/usr/bin/env python3
"""
Associate Shifted Regions with Promoters for NSC_GFP vs Neu_GFP Comparison

This script takes the BED files containing shifted chromatin regions between NSC_GFP and Neu_GFP
and associates them with gene promoters from the mm10 genome using the provided GTF annotation file.
"""
...
def main():
    parser = argparse.ArgumentParser(description='Associate shifted regions with gene promoters for NSC_GFP vs Neu_GFP comparison')
    ...
    logger.info(f"Starting gene promoter association analysis for NSC_GFP vs Neu_GFP comparison")
